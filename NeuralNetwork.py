...
class NeuralNetwork(object):
    ...
    def train(self, inputs_list, targets_list):
        ...
        self.weights_hidden_to_output += self.lr * (
                    output_errors * hidden_outputs).T  # update hidden-to-output weights with gradient descent step
        self.weights_input_to_hidden += self.lr * np.dot(hidden_errors.T * hidden_grad,
